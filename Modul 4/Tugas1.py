...
partners = [
    ...
    {'id': 3, 'name': 'John', 'description': 'Musisi handal', 'reserved': False},
    {'id': 4, 'name': 'Emma', 'description': 'Penggemar kuliner', 'reserved': False},
    {'id': 5, 'name': 'Mike', 'description': 'Atlet profesional', 'reserved': False},
    {'id': 6, 'name': 'Lucy', 'description': 'Penyuka seni', 'reserved': False}
]
...
def add_even_partners(partners):
    even_partners = list(filter(lambda partner: partner['id'] % 2 == 0, partners))
    return even_partners
